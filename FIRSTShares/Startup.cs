...
namespace FIRSTShares
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = "Data Source=firstshares.ceovzqggb3yp.us-east-2.rds.amazonaws.com,1433;Initial Catalog=Db_FirstShares;persist security info=True;user id=admin;password=senha123";
